...
from trainer.models import Personal, Client, WorkoutPlan
...
class ClientSerializer(serializers.ModelSerializer):
    workout = NestedWorkoutPlanSerializer()

    class Meta:
        model = Client
        fields = ["name", "address", "workout"]
    ...
    def update(self, instance, validated_data):
        ...
        workout_plan_data = validated_data.get('workout')
